...
// const Trending = () => {
//   // State to toggle the emoji picker
...
//   return (
//     <section className="flex flex-col relative shadow-[0_1px_3px_0_rgba(166,175,195,0.4)] rounded-lg m-1 p-4 bg-white">
//       <div className="gap-y-3 flex flex-col gap-[10px] w-full relative">
//         <div className="flex flex-col w-full gap-[10px] sm:gap-1">
//           <div className="flex gap-2 flex-col lg:flex-row justify-between w-full">
//             <div className="flex flex-row items-center">
//               <p className="text-sm font-medium text-text-primary text-nowrap truncate max-w-48 sm:text-base">
//                 Chole Edwards
//               </p>
//               <p className="text-xs capitalize text-text-primary font-semibold rounded-md px-3 py-1.5 bg-[#3758f9]/10 truncate w-fit max-w-48">
...
//           <div>
//             <p>
// Episode 2 really made me think about the role of journalists. The
// discussion around ethics was eye-opening. Thanks, Codie, for
// sparking such important conversations!
//             </p>
...
const trendingData: TrendingProps = [
  {
    id: 1,
    name: "Tiffiany Stone",
    tag: "4.0 To Pro",
  ...
  return (
    <>
      <section className=" bg-white flex items-center justify-center min-h-screen">
        <div className="flex flex-col relative lg:w-[55%] lg:mx-auto gap-3 lg:gap-6">
          <div className="flex flex-col relative shadow-[0_1px_3px_0_rgba(166,175,195,0.4)] rounded-lg m-1 p-4 bg-white ">
            <div className="flex flex-row justify-between p-4">
              <p className="text-sm font-medium text-[#0E1323] text-nowrap truncate max-w-48 sm:text-sm">
                Tiffiany Stone
              </p>
              <div className="flex flex-row gap-2">
                <p className="text-xs capitalize text-[#0E1323] font-semibold rounded-md px-3 py-1.5 bg-[#3758f9]/10 truncate w-fit max-w-48">
                  4.0 To Pro
                </p>
                <p className="flex flex-row gap-1 items-center">
                  1m
