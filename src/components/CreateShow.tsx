      ...
      <section className="flex flex-col px-4 lg:p-24 py-16 gap-9 w-full bg-secondary-lite max-w-screen-2xl mx-auto bg-[#F1F1F1] dark:bg-[#f1f1f1] text-black dark:text-black">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-3 w-full overflow-x-auto xl:overflow-x-visible no-scrollbar hover:scrollbar-thin items-start">
            <div className="flex flex-row gap-4 overflow-x-auto scrollbar-hide pb-4 pt-2 cursor-pointer">
              {pricingData.map((plan, index) => (
                <div
                  key={index}
                  className={`border rounded-lg p-6 shadow-md flex flex-col justify-between  border-tertiary px-6 py-9 gap-1 c shrink-0 overflow-hidden bg-white hover:bg-black hover:text-white w-60 h-auto ${
                    plan.title === "Indie" ? "bg-white" : "bg-white"
                  }`}
                >
                  <h2 className="text-xl font-bold">{plan.title}</h2>
                  <p className="text-lg font-semibold ">{plan.price}</p>
                  <p className="text-sm text-gray-600 ">{plan.emailLimit}</p>
                  <ul className="mt-4 ">
...
function Testinomails() {
  return (
    <>
      <div className="flex px-4 lg:p-24 py-16 items-center justify-center gap-16 bg-black">
        <div className="flex flex-col lg:flex-row md:gap-16 gap-6 items-center">
          <Image
          ...
          <div className="flex flex-col gap-4 w-full max-w-[650px]">
            <h2 className="text-[20px] font-semibold text-white text-center md:text-left leading-[120%]">
              “Station has been a driving force behind helping us build and
              engage the New Heights fan base this year.”
            </h2>
            <p className="md:text-lg text-white text-center md:text-left leading-[100%] font-medium">
              Jake Perlmutter, Strategy &amp; Operations, Wave Sports +
              Entertainment
            </p>
          </div>
        </div>
      ...
      >
        <div className="flex justify-center mt-20 px-3 py-2 ">
          <div className=" rounded-lg  p-4 w-full max-w-lg relative">
            <div className="flex flex-col gap-2">
              <h5 className="text-[28px] md:text-[40px] md:leading-[36px] font-bold text-text-primary tracking-tighter">
                Claim your Station, it’s free!
              </h5>
              <p className="md:text-lg text-text-primary font-semibold">
                Unlock your audience, and monetize faster.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-y-4">
              ...
              <div>
                <Button
                  ...
                  color="w-full items-center justify-center whitespace-nowrap rounded-md transition-all duration-200 text-sm font-medium disabled:opacity-50 focus-visible:outline-none bg-gradient-to-r from-[#FE0307] to-[#D90AB9] text-white opacity-100 hover:opacity-90 py-2 px-4 shadow"
                  size="px-6 py-2.5"
                  className="rounded"
                >
                  Claim your Show
