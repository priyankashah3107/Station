// /* The above code is a React component called `LeftNavbar` that represents a sidebar navigation menu.
...
//       {/* Sidebar */}
//       <nav
//         className={`fixed top-0 left-0 h-screen  bg-[#f1f1f1] border-r border-gray-200 transform transition-transform z-50 ${
//           isMobileOpen
//             ? "translate-x-0 lg:w-[200px] "
//             : "translate-x-full  lg:w-[64px]"
//         } lg:translate-x-0 lg:w-[64px] ${
//           isExpanded ? "lg:w-[210px]" : "lg:w-[64px]"
//         }`}
//       >
...
//                 <div
//                   key={icon.id}
//                   className="flex items-center gap-4 p-2 hover:bg-gray-300 rounded-md cursor-pointer"
//                 >
//                   <Image
//                     src={icon.image}
//                     alt={icon.label}
...
//                 className="size-6"
//               />
//               {isExpanded && <span className="text-gray-700">Profile</span>}
//             </div>
//           </div>
//         </div>
//       </nav>
...
const community = [
  { id: 1, name: "Fan Feed" },
  { id: 2, name: "Football Talk" },
  { id: 3, name: "Flim Club Suggestion" },
  { id: 4, name: "Guest Suggestion" },
  { id: 5, name: "No Dumb Question" },
];
...
const LeftNavbar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <nav
        className={`fixed top-0 left-0 h-screen bg-[#f1f1f1] border-r border-gray-200 transition-all duration-300 z-40
          ${isMobileOpen ? "w-[200px]" : "-translate-x-full"} 
          lg:translate-x-0 lg:w-[${isExpanded ? "200px" : "64px"}]`}
      >
        <div className="flex flex-col h-full justify-between">
          {/* Top Section */}
          <div className="flex flex-col">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    <div>
                      <path
                        className="hidden md:block "
                        d="M1615.9 100C1615.5 100 1615.2 99.9 1615 99.7C1614.8 99.5 1614.7 99.2 1614.7 98.8V27.2C1614.7 26.7333 1614.8 26.4 1615 26.2C1615.27 25.9333 1615.6 25.8 1616 25.8H1639.1C1647.97 25.8 1654.8 27.4333 1659.6 30.7C1664.47 33.9667 1666.9 38.7333 1666.9 45C1666.9 49 1665.83 52.4 1663.7 55.2C1661.63 57.9333 1658.33 60.1 1653.8 61.7C1653.53 61.7667 1653.4 61.9 1653.4 62.1C1653.4 62.3 1653.53 62.4333 1653.8 62.5C1658.6 63.7 1662.27 65.7667 1664.8 68.7C1667.4 71.5667 1668.7 75.4 1668.7 80.2C1668.7 86.8667 1666.2 91.8333 1661.2 95.1C1656.2 98.3667 1649.07 100 1639.8 100H1615.9Z"
                        fill="black"
                      />
                    </div>
                    <rect width="464" height="464" rx="60" fill="black" />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M84.7011 196.503C65.1438 215.998 65.0933 247.656 84.5883 267.214L196.232 379.214C215.727 398.772 247.386 398.822 266.943 379.327L379.215 267.412C398.772 247.917 398.823 216.259 379.328 196.702L267.684 84.7011C248.189 65.1437 216.531 65.0933 196.973 84.5883L84.7011 196.503Z"
                      fill="white"
                    />
                  </svg>
                </div>
          ...
          {(isExpanded || isMobileOpen) && (
            <div className="flex flex-col gap-4 py-2 px-4">
              ...
              {community.map((val) => (
                <ul
                  key={val.id}
                  className="text-[#0E1323] w-full cursor-pointer"
                >
                  <div className="flex flex-row gap-2 hover:bg-[#d1d1d1] p-2 rounded-md">
                    <svg
                      className="shrink-0 size-5"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
